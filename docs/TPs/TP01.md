...
| Cross-validation (10) : | 0.496 | 0.486 | 0.453 | 
| Leave one out (214) : | 0.483 | 0.495 | 0.448 | 
| Hold out (70%) : | 0.506 | 0.422 | 0.438 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.506
...
| Cross-validation (10) : | 0.709 | 0.706 | 0.704 | 
| Leave one out (214) : | 0.704 | 0.701 | 0.701 | 
| Hold out (70%) : | 0.653 | 0.641 | 0.641 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.709
...
| Cross-validation (10) : | 0.670 | 0.668 | 0.668 | 
| Leave one out (214) : | 0.671 | 0.668 | 0.668 | 
| Hold out (70%) : | 0.649 | 0.609 | 0.604 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Leave one out (214) 
la valeur qu'il a donné : 0.671

comparaison à l'aide du **Recall** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.668
...
le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.802

comparaison à l'aide du **Recall** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.792

comparaison à l'aide du **Precision** :

le meilleur résultat est Cross validation (10) 
la valeur qu'il a donné : 0.795
...
le meilleur algorithme est : **OneR** 
...
| Hold out (70%) : | 0.910 | 0.900 | 0.901 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.910
...
| Cross-validation (10) : | 0.927 | 0.924 | 0.925 | 
| Leave one out (435) : | 0.926 | 0.924 | 0.925 | 
| Hold out (70%) : | 0.920 | 0.908 | 0.909 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Cross validation (10) 
la valeur qu'il a donné : 0.927
...
| Cross-validation (10) : | 0.963 | 0.963 | 0.963 | 
| Leave one out (435) : | 0.968 | 0.968 | 0.968 | 
| Hold out (70%) : | 0.962 | 0.962 | 0.962 | 
**Comparaison** :

comparaison à l'aide du **F-Measure** :

le meilleur résultat est : Leave one out (435) 
la valeur qu'il a donné : 0.968
